<!--
 * 分段控制器中随选中项滑动的指示块：位置直接消费 radix YdTabs 暴露的
...
import type { TabsIndicatorProps } from '@ydsz-core/ydsz-vue';

import { computed } from 'vue';

import { cn } from '@ydsz-core/shared/utils';

import { TabsIndicator, useForwardProps } from '@ydsz-core/ydsz-vue';
