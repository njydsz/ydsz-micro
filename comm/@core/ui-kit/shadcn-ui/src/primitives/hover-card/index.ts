 ...
 *
 * 未内置 Provider：YdHoverCardRoot 的延迟在 Root 上配置（openDelay / closeDelay），
 * 不需要像 YdTooltipRoot 那样共享延迟，因此也就不必多一层包装。
 *
 * @path comm\@core\ui-kit\shadcn-ui\src\ui\hover-card\index.ts
 * @author ydsz-team
 * @since 1.0.0
 */
export { default as YdHoverCardRoot } from './YdHoverCardRoot.vue';
