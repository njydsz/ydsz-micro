...
<template>
  <div
    class="gradient-subtle flex size-full flex-col items-center justify-center duration-300"
    role="main"
  ...
  >
    ...
    <component
      ...
      class="animate-in md:1/3 h-1/3 w-1/2 lg:w-1/4"
      aria-hidden="true"
    />
    ...
    <div class="flex-col-center mt-8">
      ...
      <p
        v-else-if="titleText"
        id="fallback-title"
        class="text-text-primary text-xl font-semibold tracking-tight md:text-2xl lg:text-3xl"
        role="heading"
        aria-level="1"
      >
        {{ titleText }}
      ...
      <p
        ...
        class="text-text-secondary mt-3 text-center text-base lg:text-lg"
      >
        {{ descText }}
      </p>
