 ...
 */
export function pageLog(params: { query?: MessageLogQueryDTO }): Promise<PageResponse<MsgLogVO[]>> {
 ...
 */
export function cancelScheduled(params: { msgId?: string }): Promise<MessageResult> {
...
export function batchProgress(
  ...
  return requestClient.get<PageResponse<MsgLogVO[]>>(`/api/v1/message/batch/${batchId}/progress`, {
    params,
  });
}
