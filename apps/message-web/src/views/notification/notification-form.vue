...
const [Modal, modalApi] = useVbenModal({
  ...
  onConfirm: async () => {
    ...
    modalApi.lock();
    try {
      if (isEdit.value) { await updateNotificationApi(formData as NotificationApi.NotificationDTO); ElMessage.success('更新成功'); }
      else { await createNotificationApi(formData as NotificationApi.NotificationDTO); ElMessage.success('创建成功'); }
