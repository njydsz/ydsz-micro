...
/**
 * 死信队列（列表页）
 * <p>消费后端契约 DeadLetterController（src/api/deadLetter.ts，auto-generated by bash/gen-contract.py）：
...
const gridOptions: VxeTableGridOptions<MsgLogVO> = {
  columns: [
    ...
    { field: 'createdAt', title: '创建时间', width: 170 },
    {
      ...
      slots: {
        default: ({ row }) =>
          h(ElButton, { size: 'small', link: true, type: 'primary', onClick: () => handleResend(row) }, () => '重发'),
      },
    },
  ],
  height: 'auto',
  ...
  formConfig: {
    ...
    items: [
      ...
      { field: 'keyword', title: '关键词', itemRender: { name: 'Input', props: { placeholder: '消息ID/接收者' } } },
    ],
  },
};
