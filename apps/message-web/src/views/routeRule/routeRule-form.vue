...
/**
 * 消息路由（表单组件）
 * <p>消费后端契约 RouteRuleController#create/update（src/api/routeRule.ts，auto-generated by bash/gen-contract.py）：
  ...
  <Modal :title="title">
    <ElForm ref="formRef" :model="formData" :rules="rules" label-width="100px" label-position="right">
      ...
      <ElFormItem label="规则编码" prop="ruleCode">
        <ElInput v-model="formData.ruleCode" placeholder="请输入规则编码（可为空）" :disabled="isEdit" />
      </ElFormItem>
      ...
      <ElFormItem label="条件表达式" prop="conditionExpr">
        <ElInput v-model="formData.conditionExpr" type="textarea" :rows="2" placeholder="请输入条件表达式" />
      </ElFormItem>
