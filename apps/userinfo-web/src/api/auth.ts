...
export function generateDeviceCode(): Promise<Record<string, Record<string, unknown>>> {
  return requestClient.post<Record<string, Record<string, unknown>>>(`/api/v1/auth/sso/device-code`);
}
...
export function secondaryAuth(data: SecondaryAuthRequest): Promise<Record<string, Record<string, unknown>>> {
  return requestClient.post<Record<string, Record<string, unknown>>>(`/api/v1/auth/secondary-auth`, data);
}
