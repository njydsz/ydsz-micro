...
export function batchUserNames(data: string[]): Promise<Record<string, string>> {
  return requestClient.post<Record<string, string>>(`/api/internal/user/batch-names`, data);
}
...
export function batchDeptNames(data: string[]): Promise<Record<string, string>> {
  return requestClient.post<Record<string, string>>(`/api/internal/dept/batch-names`, data);
}
...
export function batchRoleNames(data: string[]): Promise<Record<string, string>> {
  return requestClient.post<Record<string, string>>(`/api/internal/role/batch-names`, data);
}
...
export function batchPostNames(data: string[]): Promise<Record<string, string>> {
  return requestClient.post<Record<string, string>>(`/api/internal/post/batch-names`, data);
}
...
export function batchCompanyNames(data: string[]): Promise<Record<string, string>> {
  return requestClient.post<Record<string, string>>(`/api/internal/company/batch-names`, data);
}
