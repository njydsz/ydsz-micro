...
export function getPasskeyRegistrationOptions(params: {
  ...
  return requestClient.get<unknown>(`/api/webauthn/passkey/registration/options`, { params });
}
...
export function getPasskeyAuthenticationOptions(): Promise<unknown> {
  return requestClient.get<unknown>(`/api/webauthn/passkey/options`);
}
...
export function getRegistrationOptions(params: {
  ...
  return requestClient.get<unknown>(`/api/webauthn/registration/options`, { params });
}
...
export function getAuthenticationOptions(params: {
  ...
  return requestClient.get<unknown>(`/api/webauthn/authentication/options`, { params });
}
