 ...
 *
 * @author ydsz-team
 * @path apps\literule-web\src\api\ruleAdmin.ts
...
export function validateBatch(data: Record<string, string>): Promise<Record<string, 'OK' | 'EMPTY' | 'SYNTAX_ERROR' | 'SANDBOX_VIOLATION' | 'UNDEFINED_VARIABLE'>> {
  return requestClient.post<Record<string, 'OK' | 'EMPTY' | 'SYNTAX_ERROR' | 'SANDBOX_VIOLATION' | 'UNDEFINED_VARIABLE'>>(`/api/v1/literule/rules/validate-batch`, data);
}
