 ...
 *
 * @author ydsz-team
 * @path apps\literule-web\src\api\ruleDecisionTable.ts
...
export function evaluateDecisionTable({ tableCode }: {
  ...
  return requestClient.post<Record<string, Record<string, unknown>>[]>(`/api/v1/literule/rules/decision-tables/${tableCode}/evaluate`, data);
}
