...
const [Modal, modalApi] = useVbenModal({
  ...
  onConfirm: async () => {
    ...
    modalApi.lock();
    try {
      if (isEdit.value) { await updateRagApi(formData as RagApi.RagDTO); ElMessage.success('更新成功'); }
      else { await createRagApi(formData as RagApi.RagDTO); ElMessage.success('创建成功'); }
