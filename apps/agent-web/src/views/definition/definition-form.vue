...
const [Modal, modalApi] = useVbenModal({
  ...
  onConfirm: async () => {
    ...
    modalApi.lock();
    try {
      if (isEdit.value) { await updateDefinitionApi(formData as DefinitionApi.DefinitionDTO); ElMessage.success('更新成功'); }
      else { await createDefinitionApi(formData as DefinitionApi.DefinitionDTO); ElMessage.success('创建成功'); }
