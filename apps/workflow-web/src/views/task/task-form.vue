...
const [Modal, modalApi] = useVbenModal({
  ...
  onConfirm: async () => {
    ...
    modalApi.lock();
    try {
      if (isEdit.value) { await updateTaskApi(formData as TaskApi.TaskDTO); ElMessage.success('更新成功'); }
      else { await createTaskApi(formData as TaskApi.TaskDTO); ElMessage.success('创建成功'); }
