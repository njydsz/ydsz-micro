...
export function listTemplates(params: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/template/list`, { params });
}
...
export function getTemplate({ templateCode }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/template/${templateCode}`);
}
...
export function listTemplateVersions({ templateCode }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/template/${templateCode}/versions`);
}
...
export function getTemplateVersion({ templateCode, version }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/template/${templateCode}/versions/${version}`);
}
...
export function listInheritedTemplates({ parentTemplateCode }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/template/${parentTemplateCode}/inherited`);
}
...
export function recommend(params: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/template/recommend`, { params });
}
...
export function recommendByBusinessType(params: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/template/recommend/byBusinessType`, { params });
}
