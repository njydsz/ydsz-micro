...
export function instanceAll(params: {
  ...
  return requestClient.get<PageResponse<Record<string, Record<string, unknown>>[]>>(`/api/v1/workflow/engine/instance/all`, { params });
}
...
export function getVariables({ id }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/engine/instance/${id}/variables`);
}
...
export function getFormRenderData({ id }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/engine/instance/${id}/formRender`, { params });
}
...
export function autoMapNodes(params: {
  ...
  return requestClient.get<Record<string, string>>(`/api/v1/workflow/engine/instance/migrate/autoMap`, { params });
}
...
export function toggleTrigger({ id }: {
  ...
  return requestClient.put<Record<string, Record<string, unknown>>>(`/api/v1/workflow/engine/instance/trigger/${id}/toggle`);
}
