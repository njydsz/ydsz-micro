...
export function taskDetail({ taskId }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/engine/task/${taskId}`);
}
...
export function rejectableNodes({ taskId }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/engine/task/${taskId}/rejectableNodes`);
}
...
export function nodeDurationStats(params: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/engine/stats/nodeDuration`, { params });
}
...
export function overdueStats(params: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/engine/stats/overdue`, { params });
}
...
export function myTodoCount(): Promise<Record<string, Record<string, unknown>>> {
  return requestClient.get<Record<string, Record<string, unknown>>>(`/api/v1/workflow/engine/todo/count`);
}
...
export function countersignByInstanceId({ instanceId }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/engine/countersign/instance/${instanceId}`, { params });
}
...
export function countersignByTaskId({ taskId }: {
  ...
  return requestClient.get<Record<string, Record<string, unknown>>[]>(`/api/v1/workflow/engine/countersign/task/${taskId}`, { params });
}
