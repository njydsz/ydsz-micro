...
export function taskDetail(path: {
  ...
  return requestClient.get<FlowTaskDetailVO>(`/api/workflow/engine/task/${taskId}`);
}
...
export function rejectableNodes(path: {
  ...
  return requestClient.get<FlowRejectableNodeVO[]>(`/api/workflow/engine/task/${taskId}/rejectableNodes`);
}
...
export function todo(params: {
  ...
  return requestClient.get<PageResponse>(`/api/workflow/engine/task/todo`, { params });
}
...
export function done(params: {
  ...
  return requestClient.get<PageResponse>(`/api/workflow/engine/task/done`, { params });
}
...
export function doneSearch(params: {
  ...
  return requestClient.get<PageResponse>(`/api/workflow/engine/task/done/search`, { params });
}
...
export function nodeDurationStats(params: {
  ...
  return requestClient.get<Record<string, unknown>[]>(`/api/workflow/engine/stats/nodeDuration`, { params });
}
...
export function overdueStats(params: {
  ...
  return requestClient.get<Record<string, unknown>[]>(`/api/workflow/engine/stats/overdue`, { params });
}
...
export function myTodoCount(): Promise<unknown> {
  return requestClient.get<unknown>(`/api/workflow/engine/todo/count`);
}
...
export function countersignByInstanceId(path: {
  ...
  return requestClient.get<Record<string, unknown>[]>(`/api/workflow/engine/countersign/instance/${instanceId}`, { params });
}
...
export function countersignByTaskId(path: {
  ...
  return requestClient.get<Record<string, unknown>[]>(`/api/workflow/engine/countersign/task/${taskId}`, { params });
}
...
export function preview(path: {
  ...
  return requestClient.get<FlowAttachmentPreviewVO>(`/api/workflow/engine/attachment/${attachmentId}/preview`);
}
