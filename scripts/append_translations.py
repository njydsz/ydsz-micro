#!/usr/bin/env python3
"""Append remaining translations to gen_i18n.py"""

# This script appends translation data for the remaining ~60 locales
# and the builder functions + main() to gen_i18n.py
...
T["eu-ES"] = {
    ...
    "msg_batchSorta": "Sorta-bidalketa", "msg_deadLetter": "Gutur minsua",
...
T["sv-SE"] = {
    ...
    "msg_batchSet": "Batchsändning", "msg_deadLetter": "Dött Brev",
